...
/*   Updated: 2023/06/29 13:54:49 by ade-bast         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	extension_check_xpm(t_game *game, char *xpm)
{
	int	len;
...
void	filling_sprite_tab(t_game *game)
{
	...
	extension_check_xpm(game,game->sprite.n_path);
	extension_check_xpm(game,game->sprite.s_path);
	extension_check_xpm(game,game->sprite.w_path);
	extension_check_xpm(game,game->sprite.e_path);
	i = 0;

...
/*   Updated: 2023/06/28 17:16:40 by achansar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/cub.h"

static void mv_forward(t_game *game, t_move *move, int **map)
{
...
static void mv_back(t_game *game, t_move *move, int **map)
{
	if (map[(int)(game->posX - game->dirX * move->moveSpeed)][(int)game->posY] == 0)
		game->posX -= game->dirX * move->moveSpeed;
	if (map[(int)game->posX][(int)(game->posY - game->dirY * move->moveSpeed)] == 0)
...
static void	mv_left(t_game *game, t_move *move, int **map)
{
	if (map[(int)(game->posX + game->dirX * move->moveSpeed)][(int)game->posY] == 0)
...
static void	mv_right(t_game *game, t_move *move, int **map)
{
	if (map[(int)(game->posX - game->dirX * move->moveSpeed)][(int)game->posY] == 0)
		game->posX -= game->planeX * move->moveSpeed;
	if (map[(int)game->posX][(int)(game->posY - game->dirY * move->moveSpeed)] == 0)
